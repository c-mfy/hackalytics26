...
# Load CSVs
df_trans = pd.read_csv("data/simple_transcripts.csv")
df_phoneme = pd.read_csv("data/phoneme_counter.csv").set_index("phoneme")
...
df_phoneme.reset_index().to_csv("data/phoneme_counter.csv", index=False)
